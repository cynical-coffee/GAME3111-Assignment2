...
void CrateApp::BuildRenderItems()
{
	...
	pyramidRitem->Mat = mMaterials["woodCrate"].get();
	...
	coneRitem->Mat = mMaterials["woodCrate"].get();
	...
	coneRitem2->Mat = mMaterials["woodCrate"].get();
	...
	coneRitem3->Mat = mMaterials["woodCrate"].get();
	...
	coneRitem4->Mat = mMaterials["woodCrate"].get();
	...
	boxRitem1->Mat = mMaterials["woodCrate"].get();
	...
	boxRitem4->Mat = mMaterials["woodCrate"].get();
	...
	boxRitem5->Mat = mMaterials["woodCrate"].get();
	...
	sphereRitem1->Mat = mMaterials["woodCrate"].get();
	...
	coneRitem5->Mat = mMaterials["woodCrate"].get();
	...
	coneRitem6->Mat = mMaterials["woodCrate"].get();
